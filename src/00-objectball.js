...
// Function to get the colors of a specific team
...
// Function to return an array containing the names of both teams
function teamNames() {
  const game = gameObject();
  return [game.home.teamName, game.away.teamName];
}

// Function to get an array of jersey numbers for a specific team
